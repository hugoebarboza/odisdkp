...
@Component({
  selector: 'app-add-service-value',
  templateUrl: './add-service-value.component.html',
  styleUrls: ['./add-service-value.component.css']
})
export class AddServiceValueComponent implements OnInit {
  ...
  title:string = "Valor de Servicio";
  totalRegistros: number = 0;
  token: any;    

  constructor(    
    public _userService: UserService,
    public dialogRef: MatDialogRef<AddServiceValueComponent>,
