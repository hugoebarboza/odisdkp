...
export class AddTeamComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    if (this.project_id && this.project_id > 0 ) {
      ...
      if (this.proyecto && this.proyecto.id > 0) {
        ...
        this.loadUserProject(this.proyecto.id);
      }
  ...
  onSubmit(equipo: [] = []) {
    ...
    const data = new Team (0, this.proyecto.id, this.forma.value.owner_id, this.forma.value.descripcion, '', equipo, this.forma.value.status, 0, '', 0, '');
