...
@Component({
  selector: 'app-add-project-categorie',
  templateUrl: './add-project-categorie.component.html',
  styleUrls: ['./add-project-categorie.component.css']
})
export class AddProjectCategorieComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AddProjectCategorieComponent>,
